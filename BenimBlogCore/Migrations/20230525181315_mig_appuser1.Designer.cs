...
namespace BenimBlogCore.Migrations
{
    ...
    [Migration("20230525181315_mig_appuser1")]
    partial class mig_appuser1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BenimBlogCore.Models.Entity.UygulamaKullanıcısı", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BenimBlogCore.Models.Entity.UygulamaRolu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("BenimBlogCore.Models.Entity.UygulamaRolu", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("BenimBlogCore.Models.Entity.UygulamaKullanıcısı", null)
                        .WithMany()
